...
```
echo "KX5X>APRS:>hello world!" | micropython aprs_mod.py -v | micropython aprs_demod.py -v -t -
```
```
===== MOD >>>>> KX5X>APRS:>hello world!
--ax25--
...
```
echo "KX5X>APRS:>hello world!" | micropython aprs_mod.py -v | python aprs_demod.py -v -t -
echo "KX5X>APRS:>hello world!" | python aprs_mod.py -v | micropython aprs_demod.py -v -t -
```
