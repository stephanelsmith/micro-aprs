...
```
echo "KW5O>APRS:>hello world!" | micropython aprs_mod.py -v | micropython aprs_demod.py -v -t -
```
```
...
```
echo "KW5O>APRS:>hello world!" | micropython aprs_mod.py -v | python aprs_demod.py -v -t -
echo "KW5O>APRS:>hello world!" | python aprs_mod.py -v | micropython aprs_demod.py -v -t -
```
